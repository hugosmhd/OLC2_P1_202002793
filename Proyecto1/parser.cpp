...
#undef YYCASE_
  ...
  "MENOS", "POR", "DIV", "PRINTF", "VOID", "INT", "TSTRING", "BOOLEAN",
  "PARA", "PARC", "RMAIN", "LLAVA", "LLAVC", "RTRUE", "RFALSE", "CORA",
  "CORC", "COMA", "';'", "$accept", "START", "MAIN", "LIST_INST",
  "INSTRUCTION", "PRINT", "PRIMITIVE", YY_NULLPTR
  };
#endif
  ...
  Parser::yyrline_[] =
  {
       0,    87,    87,    95,   101,   106,   113,   116,   119
  };
